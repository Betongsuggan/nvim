{ ... }: {
  keymaps = [
    ...
    }
    {
      ...
      key = "<leader>bD";
      action = {
        __raw = "function() Snacks.bufdelete({ force = true }) end";
      };
      options = {
        desc = "Force delete buffer (preserve layout)";
      };
    }
    {
      mode = "n";
      ...
      options = {
        desc = "Reload: check buffer against disk";
      };
    }
    {
      mode = "n";
      ...
      action = "<cmd>edit!<CR>";
      options = {
        desc = "Reload: discard buffer, take disk version";
      };
    }
    {
      mode = "n";
      ...
      action = "<cmd>write!<CR>";
      options = {
        desc = "Force write: overwrite disk with buffer";
      };
    }
    {
      mode = "n";
      ...
      options = {
        desc = "Diff buffer vs. disk version";
      };
    }
    {
      mode = "n";
    ...
    }
    {
      ...
      key = "<leader>fS";
      action = {
        __raw = "function() Snacks.picker.lsp_workspace_symbols({ pattern = vim.fn.expand('<cword>') }) end";
      };
      options = {
        desc = "Search symbol under cursor";
      };
    }
    {
      mode = "n";
    ...
    }
    {
      ...
      key = "<leader>fc";
      action = {
        __raw = "function() Snacks.picker.command_history() end";
      };
      options = {
    ...
    # Code Actions
    {
      ...
      key = "<leader>ch";
      action = {
        __raw = "function() _G.keymap_toggle_inlay_hints() end";
      };
      options = {
    ...
    }
    {
      ...
      key = "<leader>xe";
      action = {
        __raw = "function() _G.keymap_show_diagnostic() end";
      };
      options = {
    ...
    # Project commands
    {
      ...
      key = "<leader>pt";
      action = {
        __raw = "function() _G.keymap_run_tests() end";
      };
      options = {
        desc = "Run tests";
      };
    }
    {
      ...
      key = "<leader>pr";
      action = {
        __raw = "function() _G.keymap_run_project() end";
      };
      options = {
        desc = "Run project";
      };
    }
    {
      ...
      key = "<leader>pb";
      action = {
        __raw = "function() _G.keymap_build_project() end";
      };
      options = {
        desc = "Build project";
      };
